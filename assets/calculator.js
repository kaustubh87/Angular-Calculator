(function () {
    ...
    app.controller('CalculatorController', ['$scope', function ($scope) {
        ...
        $scope.calculate = function(){
            ...
            $scope.inc_wattage = ($scope.inc_conversion * $scope.current_lumens).toFixed(1);
            $scope.hal_wattage = ($scope.hal_conversion * $scope.current_lumens).toFixed(1);
            $scope.cfl_wattage = ($scope.cfl_conversion * $scope.current_lumens).toFixed(1);
            $scope.led_wattage = ($scope.led_conversion * $scope.current_lumens).toFixed(1);
